    ...
    <div class="site-nav-inner">
        ...
        <div class="site-nav-right">
            ...
            <div class="site-nav-social" aria-label="Social links">
                ...
                <a href="#" class="site-nav-social-link" aria-label="Vimeo" target="_blank" rel="noopener noreferrer">
            ...
            {{-- Theme toggle --}}
            <button class="site-nav-theme" id="themeToggle" aria-label="Toggle light/dark mode">
                {{-- Moon: shown in dark mode --}}
                <svg class="theme-icon theme-icon--dark" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                    <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/>
                </svg>
                {{-- Sun: shown in light mode --}}
                <svg class="theme-icon theme-icon--light" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                    <circle cx="12" cy="12" r="5"/>
